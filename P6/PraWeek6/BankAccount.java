...
class Person {
	...
	/**
	 * Menampilkan daftar akun bank berupa no rekening dan nama bank dan saldo dari
	 * objek person.
...
public class BankAccount implements ITransaksi {
	...
	/**
	 * Method transfer, saldo akunbank pengirim akan berkurang dan saldo akunbank
	 * penerima akan bertambah

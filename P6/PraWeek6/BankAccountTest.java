			...
			switch (menu) {
				...
				case "5" -> {
					try {
						...
						String noRek = in.nextLine();
						System.out
								.println("Masukkan jumlah uang (Rp.) yang ingin ditarik (Pastikan saldo tersedia)? contoh: 10000");
						Double jumlahUang = in.nextDouble();
						// Setorkan ke akunbank dari objek person terkait
						BankAccount ba = p.get(i - 1).getAkunBank(noRek);
				...
				case "6" -> {
					try {
						...
						String noRek = in.nextLine();
						System.out
								.println("Masukkan jumlah uang (Rp.) yang ingin dikirim (Pastikan saldo tersedia)? contoh: 10000");

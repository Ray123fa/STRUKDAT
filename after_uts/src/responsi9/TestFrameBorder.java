 ...
 */
public class TestFrameBorder extends javax.swing.JFrame {

  /**
   * Creates new form TestFrame
   */
  public TestFrameBorder() {
    initComponents();
  }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(TestFrameBorder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new TestFrameBorder().setVisible(true);
      }
    });
  }

...
public class Visit {
	...
	public Visit(Customer6 customer, LocalDate date) {
	...
	public String toString() {
		String text = "Customer[" + customer + ", date=" + date + ", serviceExpense=" + serviceExpense;

		if (customer.isMember()) {
			text += ", serviceDiscount=" + DiscountRate.getServiceDiscountRate(customer.getMemberType()) * 100 + "%";
		}
		text += ", productExpense=" + productExpense;

		if (customer.isMember()) {
			text += ", productDiscount=" + DiscountRate.getProductDiscountRate(customer.getMemberType()) * 100 + "%";
		}
